...
class Maths_10_sn : AppCompatActivity() {
    var sb_maths: WebView? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_maths10_sn)

        sb_maths = findViewById(R.id.maths_pdf)

        sb_maths!!.getSettings().javaScriptEnabled = true
        sb_maths!!.setWebViewClient(WebViewClient())
        sb_maths!!.loadUrl("https://drive.google.com/file/d/13ZBiyt8uxtSaTvgV1ILw1pKTzcx_YSZy/view?usp=drive_link")
