...
class SST_10_sb : AppCompatActivity() {
    var sb_sst: WebView? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_sst10_sb)
        sb_sst = findViewById(R.id.sst_pdf)

        sb_sst!!.getSettings().javaScriptEnabled = true
        sb_sst!!.setWebViewClient(WebViewClient())
        sb_sst!!.loadUrl("https://drive.google.com/file/d/1FkvHCnsXjh8qYjGecqwFRuPkGaRq0T1_/view?usp=drive_link")
